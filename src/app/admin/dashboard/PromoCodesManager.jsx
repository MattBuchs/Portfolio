		...
		<div className="space-y-6">
			...
			<div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
				...
				<button
					...
					className="px-4 py-2 bg-linear-to-r from-amber-500 to-orange-600 text-white rounded-xl font-semibold hover:shadow-lg hover:shadow-amber-500/20 transition-all flex items-center gap-2 cursor-pointer"
				>
			...
			<div className="relative">
				...
				<input
					...
					className="w-full pl-12 pr-4 py-3 bg-zinc-800/50 border border-zinc-700/50 rounded-xl text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50"
				/>
			</div>
										...
										>
											<td className="px-6 py-4">
												<div className="flex items-center gap-2">
													<code className="px-3 py-1 bg-zinc-900/50 border border-zinc-700 rounded-lg font-mono text-sm font-semibold text-white">
														{promo.code}
													</code>
													{(expired ||
														maxUsesReached) && (
													...
													{promo.applicablePlans
														...
														promo.applicablePlans.map(
															(plan) => (
																<span
																	key={plan}
																	className="text-xs px-2 py-1 bg-amber-500/10 text-amber-400 border border-amber-500/20 rounded"
																>
																	{plan}
																</span>
															),
			...
			{showCreateModal && (
				<div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
					<motion.div
						...
						className="bg-zinc-800 rounded-2xl p-8 max-w-2xl w-full max-h-[90vh] overflow-y-auto border border-zinc-700/50"
					>
						...
						>
							<div>
								...
								<input
									...
									className="w-full px-4 py-3 bg-zinc-900/50 border border-zinc-700 rounded-xl text-white placeholder-zinc-500 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500/50 uppercase font-mono"
							...
							<div className="flex gap-4 pt-4">
								<button
									type="button"
									onClick={() => setShowCreateModal(false)}
									className="flex-1 px-6 py-3 border border-zinc-700 text-zinc-300 rounded-xl font-semibold hover:bg-zinc-700/50 transition-colors cursor-pointer"
								>
									Annuler
								</button>
								<button
									...
									className="flex-1 px-6 py-3 bg-linear-to-r from-amber-500 to-orange-600 text-white rounded-xl font-semibold hover:shadow-lg hover:shadow-amber-500/20 transition-all disabled:opacity-50 cursor-pointer"
								>
